...
- I would love to spend time explaining every section of the code in charge to perform all UI actions and how http requests return the expected data but I need to get back to work to pay bills, bank loan and food to survive, so you have to take a look into the folder structure to learn how it works. I tried to use best practices and place everything in the right place but the lack of time made me a bit lazy in some parts of it. however I believe this is the most complete fullstack project around internet.
